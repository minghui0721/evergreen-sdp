...
if(isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM student WHERE student_ID LIKE '%$search_keyword%' OR program_ID LIKE '%$search_keyword%' OR course_ID LIKE '%$search_keyword%' OR student_name LIKE '%$search_keyword%' OR student_password LIKE '%$search_keyword%'OR email LIKE '%$search_keyword%'OR phone LIKE '%$search_keyword%'ORDER BY id ASC";
} else {
            ...
            <?php while($row = mysqli_fetch_assoc($results)) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa-solid fa-eraser"></i><a href="#">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
