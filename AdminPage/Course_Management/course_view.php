...
<head>
    ...
    <link rel="stylesheet" href="course_view.css?v=<?php echo time(); ?>"> <!-- Include your CSS file -->
...
<style>
    ...
    .AcademicManagement .ManageCourse{
        color: #5c5adb;
    }
</style>
...
<body>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <input type="submit" value="Edit Course <?php echo isset($_POST['courseProgram_ID']) ? '(ID: ' . $_POST['courseProgram_ID'] . ')' : ''; ?>">
