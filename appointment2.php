...
<head>
    ...
    <title>Appointment Steps</title>
    <link rel="shortcut icon" href="../logo.png" type="image/x-icon">
    <link rel="stylesheet" href="appointment2.css?v=<?php echo time(); ?>">
</head>

<body>

    <!-- Header -->
    <div class="header" id="home_section">
        <div class="left">
            <p>123-456-7890 | well@gmail.com</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="menu">
            <ul>
                <a href="../home_user/home_login.php"><li><button id="home">Home</button></li></a>
                <a href="../home_user/aboutus/about.php"><li><button id="aboutus">About Us</button></li></a>
                <a href="../home_user/donation/donation.php"><li><button id="donation">Donation</button></li></a>
                <a href="../home_user/career/career.php"><li><button id="career">Career</button></li></a>
                <a href="../home_user/contactus/contact_us.php"><li><button id="contactus">Contact Us</button></li></a>
            </ul>
        </div>
    </div>
    ...
    <div id="container1">
        ...
        <!-- Left Side -->
        <div id="left">
            <h2>Make your request in easy  steps</h2>
            <hr>
            <p>An appointment coordinator will use this info when <br> they discuss your request.</p>
        </div>
    
        <!-- Right Side -->
        <div id="right">
        <h2>
            1. Choose departments <br>
            2. Describe your medical concerns <br>
            3. Choose a time for appointment <br>
            4. Confirm your info
        </h2>
        </div>
        ...
        <!-- A Continue Button -->
        <div id="button">
            <a href="services.php"><p>Continue</p></a>
        </div>
    ...
    <div class="container7">
        <div class="row1">
            <div class="column">
                <h3>Address</h3>
                <p>Jalan Teknologi 5,Taman Teknologi Malaysia,57000 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpu</p>
            </div>
                
           
            <div class="column">
                <h3>Opening Hours</h3>
                <p>Monday-Sunday: 7.00am - 7.30pm <br>Sunday: 7.00am - 4.30pm</p>
            </div>
        ...
        <div class="row2">
                <p>&copy; 2023 ElderlyCare. All Rights Reserved.</p>
        </div>
    </div>
